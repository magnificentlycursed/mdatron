# MDATRON-E0090 — unregistered-coinage
...
Register the term in .mdatron/vocabulary.yaml (status registered, with its sense), register it as draft while it settles, or unbold the emphasis if no coinage was intended.
